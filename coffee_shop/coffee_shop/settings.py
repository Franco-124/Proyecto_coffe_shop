...
SECRET_KEY = 'django-insecure-6n)i!cjgp(=xjit(4e@evqi9l#mve$npe01j!d$arki!z34p@t'
...
DATABASES = {
    'default': env.db('DJANGO_DB_URL', default='postgres://johan:2122@localhost:5432/coffee_shop')
}
